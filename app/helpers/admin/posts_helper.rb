module Admin::PostsHelper
  def admin_post_stats(new_post_count:, awaiting_review_count:, pending_count:, draft_count:, reviewed_today_count:, verified_today_count:)
    [
      {
        label: t("shared.posts.index.stats.pending_posts"),
      ...
      {
        label: t("shared.posts.index.stats.awaiting_review"),
      ...
      {
        label: t("shared.posts.index.stats.verified_today"),
      ...
      {
        label: t("shared.posts.index.stats.open"),
        value: draft_count,
      ...
      {
        label: t("shared.posts.index.stats.pending_revisions"),
        value: pending_count,
      ...
      {
        label: t("shared.posts.index.stats.reviewed_today"),
  ...
  def admin_scope_options
    {
      "posts" => t("shared.posts.index.scopes.posts"),
      "revisions" => t("shared.posts.index.scopes.revisions")
    }
  end
  ...
  def admin_filter_options(scope)
    if scope == "posts"
      {
        "all_posts" => t("shared.posts.index.filters.all_posts"),
        "awaiting_review" => t("shared.posts.index.filters.awaiting_review"),
        "rejected" => t("shared.posts.index.filters.rejected"),
        "ai_needs_admin_review" => t("shared.posts.index.filters.ai_needs_admin_review"),
        "ai_auto_approved" => t("shared.posts.index.filters.ai_auto_approved"),
        "ai_failed" => t("shared.posts.index.filters.ai_failed"),
        "ai_pending" => t("shared.posts.index.filters.ai_pending")
      }
    elsif scope == "revisions"
      {
        "pending" => t("shared.posts.index.filters.pending"),
        "open" => t("shared.posts.index.filters.open"),
        "reviewed" => t("shared.posts.index.filters.reviewed")
      }
    else
      {}
    end
